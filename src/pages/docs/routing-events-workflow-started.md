...
![Execution results](/routing-events-workflow-started-1.png)
...
![Create rule and add name](/routing-events-workflow-started-2.png)
...
![Select targets panel](/routing-events-workflow-started-3.png)
...
![Select event bus](/routing-events-workflow-started-4.png)
3. Choose **Send events**
![Select send events](/routing-events-workflow-started-5.png)
...
![Select send events](/routing-events-workflow-started-6.png)
...
![Execution results](/routing-events-workflow-started-7.png)

4. The two most recent log streams shown contain the two events.

![Log streams](/routing-events-workflow-started-8.png)
...
![Execution results](/routing-events-workflow-started-9.png)
...
![DynamoDB table](/routing-events-workflow-started-10.png)
...
![Item content](/routing-events-workflow-started-11.png)
