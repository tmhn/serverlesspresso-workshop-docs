...
![Choose Edit](/1a-building-workflow-is-shop-open-1.png)
...
![Delete the pass state](/1a-building-workflow-is-shop-open-2.png)
...
![Drag GetItem to designer](/1a-building-workflow-is-shop-open-3.png)
...
```
![Drag GetItem to designer](/1a-building-workflow-is-shop-open-4.png)
...
![Drag GetItem to designer](/1a-building-workflow-is-shop-open-5.png)
...
![Drag GetItem to designer](/1a-building-workflow-is-shop-open-6.png)
...
![Drag PutEvents to designer](/1a-building-workflow-is-shop-open-7.png)

3. In the *Flow* tab, drag the *Pass* state to the *Default* empty box under the choice state.

![Drag Pass state to designer](/1a-building-workflow-is-shop-open-8.png)
...
![Edit rule icon](/se-mod1-edit-rule.png)

5. Choose **Add conditions**.

![Edit choice state](/1a-building-workflow-is-shop-open-9.png)
...
![Edit conditions](/1a-building-workflow-is-shop-open-10.png)

7. For *State name*, add `Shop Open?`.

![Edit state name](/1a-building-workflow-is-shop-open-11.png)
...
![Drag GetItem to designer](/1a-building-workflow-is-shop-open-12.png)
...
![Execution results](/1a-building-workflow-is-shop-open-16.png)
