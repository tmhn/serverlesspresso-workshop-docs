...
![The Order manager workflow](/routing-events-order-manager-workflow-1.png)
...
![The Order manager workflow](/routing-events-order-manager-workflow-2.png)
...
```
![The Order manager workflow](/routing-events-order-manager-workflow-3.png)
...
![The Order manager workflow](/routing-events-order-manager-workflow-4.png)
...
![The Order manager workflow](/routing-events-order-manager-workflow-5.png)
